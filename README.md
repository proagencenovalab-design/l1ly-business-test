...
Fixes broken Whop checkout links.

Issue observed:
The bot sent an old `/checkout/plan_...` URL, and Whop displayed "Nothing to see here yet".

Fix:
- Adds canonical safe fallback product URLs:
  - Starter: https://whop.com/lily-novalab/lily-rose-photo-pack-s
  - Premium: https://whop.com/lily-novalab/premium-pack-xl-bc/
- If Railway variables contain an old `/checkout/plan_...` link, the bot ignores it and uses the canonical product page.
- Version: `v1.0.3-link-fix`

Recommended Railway variables:
- WHOP_STARTER_LINK=https://whop.com/lily-novalab/lily-rose-photo-pack-s
- DIRECT_PRODUCT_LINK=https://whop.com/lily-novalab/lily-rose-photo-pack-s
- WHOP_PREMIUM_LINK=https://whop.com/lily-novalab/premium-pack-xl-bc/
