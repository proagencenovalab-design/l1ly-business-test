...
## v11.2 age gate strict

Age gate now works like this:
1. First adult/unsafe message before age confirmation: soft human age question.
2. If the prospect ignores the question: firm reminder.
3. If they still ignore it: the bot ends the discussion.
4. After that, the bot stops replying until clear 18+ confirmation.

This prevents age-gate spam and prevents adult conversation with unconfirmed users.
